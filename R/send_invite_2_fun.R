...
send_invite_2_fun <- function(dat, senden) {
  for (i in 1:dim(dat)[1]) {
    prepare_email(
      ...
      body = glue(
        ...
        "Vor ca. 6 Monaten hatten wir Sie eingeladen, den ", dat$Befragung[i]-1, ". Fragebogen zu sich ver&auml;ndernden gesundheitlichen
