...
#'
#' send_remind_fun_3() erlaubt das versenden der dritten, und letzten, Erinnerungsmail an die Teilnehmer innerhalb der ersten Welle
    ...
    for (i in 1:dim(dat)[1]) {
      prepare_email(
        ...
        body = glue(
          ...
          "vor drei Wochen haben wir Sie zu einer Befragung im Rahmen der NAKO-Gesundheitsstudie eingeladen und erinnert.
      ...
      zus&auml;tzlichen,
      sich alle 6 Monate wiederholenden Befragung teilzunehmen. Dies ist die letzte Erinnerung und Sie werden innerhalb dieser ersten Befragung keine weiteren Schreiben von uns erhalten. <p>",
      ...
      Telefonnummer <b>(0345) 557-7939</b> kontaktieren oder direkt auf diese Mail antworten.<p>",
        ...
        #cc = "jazzy_grind",
        subject = paste0(
          "Letzte Erinnerung an die Einladung zur Teilnahme an der zusätzlichen Befragung der NAKO Gesundheitsstudie ",
          "(B",
          dat$Befragung[i],
          ", A",
          dat$Erinnerung[i] + 1,
      ...
      message(ifelse(
        senden,
        paste("3./Letzte Erinnerung wurde an", dat$Email[i], "versendet"),
