...
#'
#' send_remind_2_fun_1() erlaubt das versenden der ersten Erinnerungsmail an die Teilnehmer ab der 2. Welle
    ...
    for (i in 1:dim(dat)[1]) {
      prepare_email(
        ...
        body = glue(
          ...
          "vor ein paar Tagen haben wir Sie zu einer ",dat$Befragung[i],". Befragung im Rahmen der NAKO-Gesundheitsstudie eingeladen.
