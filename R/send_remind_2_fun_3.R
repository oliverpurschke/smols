#' Dritten / Letzten Reminder versenden
#'
#' send_remind_2_fun_3() erlaubt das versenden der dritten, und letzten, Erinnerungsmail an die Teilnehmer innerhalb der ersten Welle
    ...
    for (i in 1:dim(dat)[1]) {
      prepare_email(
        ...
        body = glue(
          ...
          "vor drei Wochen haben wir Sie zu einer ",dat$Befragung[i],". Befragung im Rahmen der NAKO-Gesundheitsstudie eingeladen.
          M&ouml;glicherweise sind Ihnen die E-Mails nicht zugestellt worden oder Sie haben die E-Mails &uuml;bersehen. Dies ist die letzte Erinnerung und Sie werden innerhalb dieser ",dat$Befragung[i],". Befragung keine weiteren Schreiben von uns erhalten. <p>",
      ...
      Telefonnummer <b>(0345) 557-7939</b> kontaktieren oder direkt auf diese Mail antworten.<p>",
        ...
        #cc = "jazzy_grind",
        subject = paste0(
          "Letzte Erinnerung an den ",dat$Befragung[i],". Fragebogen der zusätzlichen Befragung der NAKO Gesundheitsstudie ",
          "(B",
          dat$Befragung[i],
          ", A",
          dat$Erinnerung[i] + 1,
      ...
      message(ifelse(
        senden,
        paste(dat$Erinnerung[i], ". ", "Erinnerung wurde an", dat$Email[i], "versendet"),
